...
import { usersSlice } from "../slices/usuariosSlice/usuariosSlice";

import { persistBuyersConfig, persistConfigFooter, persistMatchesConfig, persistPostsConfig, persistSellersConfig, persistCategoriesConfig, persistUsersConfig } from "./persistConfigKeys"
...
const persistedUsers = persistReducer(persistUsersConfig, usersSlice.reducer)
